...
describe('checkoutSlice', () => {
  it('should handle updateStart', () => {
    ...
    const nextState = paymentReducer(initialState, updateStart());
  ...
  it('should handle updateSuccess', () => {
    ...
    const nextState = paymentReducer(initialState, updateSuccess(payload));
    expect(nextState.successCondition).toBe(true);
    expect(nextState.pending).toBe(false);
    expect(nextState.paymentInfo).toEqual(payload);
  });
  ...
  it('should handle updateError', () => {
    ...
    const nextState = paymentReducer(initialState, updateError(payload));
  ...
  it('should handle clearError', () => {
    ...
    const nextState = paymentReducer(initialState, clearError());
  ...
  it('should handle clearSuccessCondition', () => {
    ...
    const nextState = paymentReducer(initialState, clearSuccessCondition());
