...
describe('USER INFORMATIONS TESTS', () => {
  ...
  it('should allow user input and form submission', async () => {
    ...
    fireEvent.change(screen.getByLabelText('Birthdate'), { target: { value: '1995-01-01' } });
    fireEvent.change(screen.getByLabelText('Preferred Language'), { target: { value: 'Spanish' } });
    // Simulate input for other form fields
    fireEvent.change(screen.getByLabelText('Preferred Currency'), { target: { value: 'EUR' } });
    fireEvent.change(screen.getByLabelText('Home Address'), { target: { value: '456 Park Avenue' } });
    fireEvent.change(screen.getByLabelText('Street'), { target: { value: 'Park Avenue' } });
    ...
    fireEvent.change(screen.getByLabelText('PO Box Number'), { target: { value: '67890' } });
    ...
    fireEvent.change(screen.getByLabelText('Profile Image'), { target: { value: 'https://pbs.twimg.com/profile_images/643271279/Screen_shot_2010-01-20_at_1.17.37_AM_400x400.png' } });
