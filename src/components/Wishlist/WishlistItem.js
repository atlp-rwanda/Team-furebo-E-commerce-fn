...
import DeleteItemInWishlistButton from './DeleteItemInWishListButton';

const WishlistItem = ({ item }) => (
  <li key={item.id} data-testid="wishlist-item" className="wishlist-item">
    ...
    <div className="wishlist-item-details">
      ...
      <div className="check-delete-conner">
        ...
        <DeleteItemInWishlistButton itemId={item.id} />
      </div>
    </div>
  </li>
);
